...
syn match cupTerm "\<[A-ZÁÉÍÓÚÑ_]\+\>" contained
syn match cupNonTerm "\<[a-záéíóúñ_]\+\>" contained
syn match cupNonTermDef "^[a-záéíóúñ]\+\>" contained
syn match cupClass "\<[A-ZÁÉÍÓÚÑ][a-záéíóúñ]\+\>" contained
